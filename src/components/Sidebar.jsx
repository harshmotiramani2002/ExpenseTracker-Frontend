...
const Sidebar = ({user,isCollapsed,setIsCollapsed}) => {
  ...
  return (
    <>
        <motion.div 
            ref={sidebarRef} className={sidebarStyles.sidebarContainer.base}
            initial={{x:-100,opacity:0}}
            animate={{x:0,width:isCollapsed?80:256,opacity:1,}}
        ...
        >
            <div className={sidebarStyles.sidebarInner.base}>
                ...
                <div className={cn(
                        ...
                        isCollapsed?sidebarStyles.footerContainer.collapsed:sidebarStyles.expanded,
                    )}
                >
                    <Link className={cn(
                ...
                >
                    ...
                    >
                        <div className='relative h-full flex flex-col'>
                            ...
                            <div className='flex-1 overglow-y-auto py-4'>
                            ...
                            <div className={sidebarStyles.mobileFooter}>
                                <Link onClick={()=>setMobileOpen(false)} to="/support" className={sidebarStyles.mobileFooterLink}>
                                    <HelpCircle size={20} className="text-gray-500"/>
                                    <span>Support</span>
                                </Link>
